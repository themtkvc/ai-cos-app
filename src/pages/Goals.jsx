...
// ═══════════════════════════════════════════════════
const UNITS = [
  { key: 'fonlar', name: 'Fonlar', icon: '💎', color: '#EAB308', coord: 'Yavuz Sofi' },
  { key: 'hibeler', name: 'Hibeler', icon: '📝', color: '#DC2626', coord: 'Yasir' },
  { key: 'insani_isler', name: 'İnsani İşler', icon: '🌍', color: '#2563EB', coord: 'Gülsüm' },
  { key: 'partnerlikler', name: 'Partnerlikler', icon: '🤝', color: '#16A34A', coord: 'Hatice' },
  { key: 'politika', name: 'Politika, Yönetişim ve Güvence', icon: '⚖️', color: '#EA580C', coord: 'Sezgin' },
];
